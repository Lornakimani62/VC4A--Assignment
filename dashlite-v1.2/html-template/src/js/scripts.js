!(function (NioApp, $) {
    ...
    NioApp.ClassNavMenu = function() {
        ...
        NioApp.BreakClass('.'+_content_sidebar, _break.lg, { timeOut: 0 } );
        NioApp.BreakClass('.'+_sidebar, _break.lg, {timeOut: 0, classAdd: _sidebar_mob} );
        NioApp.BreakClass('.'+_sidebar_fat, _break.xl, {timeOut: 0, classAdd: _sidebar_mob} );
        $win.on('resize', function() {
            ...
            NioApp.BreakClass('.'+_sidebar_fat, _break.xl, {classAdd: _sidebar_mob} );
        });
    };
    ...
    NioApp.BS.init = function() {
        ...
        NioApp.BS.tooltip('.tipinfo', {placement: 'right'});
